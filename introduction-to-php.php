...
echo "<br>CSS - Stands for Cascading Stylesheet";
echo "<br>JS - Stands for JavaScript";
echo "<br>PHP - Stands for Hypertext Preprocessor";
echo "<br>SQL - Stands for Structural Query Language";
...
<li>SQL - Stands for Structural Query Languag</li>
</ul>";
